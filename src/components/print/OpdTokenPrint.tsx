/**
 * OPD Token Print Template — 76mm × 55mm thermal receipt
 */
  ...
  return (
    <div
      ...
      style={{
        ...
        minHeight: size === 'thermal' ? '55mm' : 'auto',
        padding: '3mm 4mm',
    ...
    >
      ...
      <div className="text-center pb-1.5 mb-1.5" style={{ borderBottom: '2px solid #8B0000' }}>
        ...
        <p style={{ fontSize: '8.5pt', color: '#555' }}>── OPD TOKEN ──</p>
      </div>

      {/* Token number */}
      <div className="text-center my-1">
        <p style={{ fontSize: '8pt', color: '#888', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Token</p>
        <p className="font-bold leading-none mt-0.5" style={{ fontSize: '30pt', color: '#8B0000' }}>
          {token.token_number}
        </p>
      </div>
